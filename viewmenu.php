	...
	<div id="navbar_top"> 
            <div class = "header">
                ...
                <div class="col-8">
					...
					<!--<li class="dropdown">
                        <button href="promotion.html" class="dropbtn">Promotions</button>
                        <div class="dropdown-content">
                          <a href="promotion1.html">CNY Special</a>
                          <a href="promotion2.html">Card members</a>
                          <a href="promotion3.html">First timers</a>
                        </div>
                    </li>-->
        ...
        <h5 class="subtext" style="text-align:center;">Menu</h2>
		</div>
				...
				echo "<div class='col-md-4 mb-5'>
							<div class='card h-100'>
								<div class='card-body'>
									...
									<a href='" .'details.php'. '?add=' .($i+1). "''><img src='".$images[$i]."' border='0'></a></span>
